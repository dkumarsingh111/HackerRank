...
if __name__ == "__main__":
    ...
    cosine_pooling = torch.dot(pool_vectors[0], pool_vectors[1])/(torch.linalg.norm(pool_vectors[0]) * torch.linalg.norm(pool_vectors[1]))  # Fill up this '----------' section
    cosine_cls = torch.dot(cls_vectors[0], cls_vectors[1])/(torch.linalg.norm(cls_vectors[0]) * torch.linalg.norm(cls_vectors[1]))  # Fill up this '----------' section
    
    # Finally print out the values (DO NOT CHANGE)
