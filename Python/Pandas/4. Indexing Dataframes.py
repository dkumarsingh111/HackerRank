# Welcome to Python Pandas | 4 | Indexing Dataframes(75 Min)
# Hands-on with IndexesFile Name: prog.py
...
mi_index = pd.MultiIndex.from_product(arraylist,names=['First Level','SecondLevel'])
